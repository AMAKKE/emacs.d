...
```
git clone --recursive https://github.com/purcell/emacs.d.git ~/.emacs.d
```
Note: this repo contains submodules so `--recursive` option is mandatory.
If you already cloned just use:
